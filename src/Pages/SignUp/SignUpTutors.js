...
const SignUpTutors = () => {
    ...
    const { createUser, updateUser } = useContext(AuthContextTwo);
    ...
    return (
        ...
        <div className='w-[664px]'>
            <h2 className='text-xl text-center'>Tutor Sign Up</h2>
            <form onSubmit={handleSubmit(handleSignUp)}>
                ...
                <input className='btn bg-indigo-700 text-white w-full mt-4' value="Sign Up" type="submit" />
