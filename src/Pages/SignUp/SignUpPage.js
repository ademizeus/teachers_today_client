...
import SignUpTutors from './SignUpTutors';
    ...
    return (
        <div>
            <div className='mt-10 signUpBanner max-w-[1600px] mx-auto flex justify-center items-center'>
                <h1 className='text-center bannerText'>Create Account</h1>
            </div>
            <div className='flex flex-col justify-center items-center '>
                ...
                <div className='mt-10 p-5'>
                    {active === "FirstCard" && <SignUpStudents title="1" />}
                    {active === "SecondCard" && <SignUpTutors title="2" />}
